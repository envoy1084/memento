...
import { ButtonLink, Reveal, RuleHeading, Section } from "#/components/common/page";
  ...
  return (
    <>
      ...
      <Section className="py-14">
        <RuleHeading>A thoughtful gift in three steps</RuleHeading>
        <div className="mt-8 grid gap-8 md:grid-cols-3">
          {[
            ["Make it personal", "Choose a budget, add a note, and enter their email."],
            ["We deliver it", "Their private invitation arrives by email."],
            [
              "They make it theirs",
              "They sign in, choose an available name, and claim. You cover registration; we cover gas.",
            ],
